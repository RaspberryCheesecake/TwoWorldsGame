...
init -1 python hide:
    ...
    config.window_title = u"Two Worlds"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "TwoWorlds"
    config.version = "0.0"
    ...
    config.main_menu_music = "Lee_Rosevere_-_17_-_I_Was_Waiting_for_Him.mp3"
...
python early:
    config.save_directory = "TwoWorlds-1523806466"
